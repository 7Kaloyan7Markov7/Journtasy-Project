...
SCREEN_LOWER_BOUNDARY = SCREEN_HEIGHT
...
# Attack sprite is bigger than the idle sprite, so its blit position is
# shifted to stay centered over the same hitbox.
ENEMY_ATTACK_OFFSET = (-34, -32)
...
KILLER_WEAPON_WIDTH = 52
KILLER_WEAPON_HEIGHT = 59
KILLER_WEAPON_FRAME_SPACE = 12
KILLER_WEAPON_SCALE = 3

WEAPON_SIZE_DATA = {
    KILLER_ID: (KILLER_WEAPON_WIDTH, KILLER_WEAPON_HEIGHT, KILLER_WEAPON_FRAME_SPACE, KILLER_WEAPON_SCALE),
}
...
# Per-weapon fine-tuning applied on top of the default edge-attached /
# vertically-centered position: (left_extra_x, right_extra_x, extra_y).
# Positive left/right_extra_x pulls the weapon closer to (or overlapping)
# the player when facing that direction; negative pushes it further away.
# Weapons not listed default to (0, 0, 0).
WEAPON_OFFSET_DATA = {
    KNIGHT_WEAPON_ID: (40, 0, 0),
}
...
ENEMY_AGGRO_SIZE = 300

PLAYER_EXP_THRESHOLD = 100
PLAYER_INVULNERABILITY_DURATION = 30

WEAPON_HIDE_POSITION = -9999

SPAWN_MARGIN = 200
MAX_SPAWN_ATTEMPTS = 100
MAX_ENEMIES_PER_ROOM = 5
MAX_OBSTACLES_PER_ROOM = 3
MAX_ENEMY_LEVEL = 3
...
KNIGHT_BASE_DAMAGE = 40
KNIGHT_DAMAGE_GROWTH = 4
KNIGHT_BASE_ARMOR = 14
KNIGHT_ARMOR_GROWTH = 3
KNIGHT_HEALING = 0.6

# Not currently selectable in character selection (no button wired up in
# BUTTON_CHARACTER_MAP) - stats kept realistic so the character is playable
# as soon as it's wired up, but nothing here has been balance-tested.
MONK_BASE_HEALTH = 180
MONK_HEALTH_GROWTH = 18
MONK_BASE_DAMAGE = 30
MONK_DAMAGE_GROWTH = 4
MONK_BASE_ARMOR = 10
MONK_ARMOR_GROWTH = 2
MONK_HEALING = 1.0

KILLER_BASE_HEALTH = 180
KILLER_HEALTH_GROWTH = 15
KILLER_BASE_DAMAGE = 55
KILLER_DAMAGE_GROWTH = 6
KILLER_BASE_ARMOR = 5
KILLER_ARMOR_GROWTH = 1
KILLER_HEALING = 0.2

WIZARD_BASE_HEALTH = 180
WIZARD_HEALTH_GROWTH = 0
WIZARD_BASE_DAMAGE = 50
WIZARD_DAMAGE_GROWTH = 6
WIZARD_BASE_ARMOR = 0
...
# BUTTON_CHARACTER_MAP) - stats kept realistic so the character is playable
# as soon as it's wired up, but nothing here has been balance-tested.
BOXER_BASE_HEALTH = 180
BOXER_HEALTH_GROWTH = 20
BOXER_BASE_DAMAGE = 45
BOXER_DAMAGE_GROWTH = 5
BOXER_BASE_ARMOR = 8
BOXER_ARMOR_GROWTH = 2
BOXER_HEALING = 0.3

CAVEMAN_BASE_HEALTH = 180
CAVEMAN_HEALTH_GROWTH = 25
CAVEMAN_BASE_DAMAGE = 25
CAVEMAN_DAMAGE_GROWTH = 3
CAVEMAN_BASE_ARMOR = 18
CAVEMAN_ARMOR_GROWTH = 4
CAVEMAN_HEALING = 0.4
...
WEAPON_HITBOX_DATA = {
    ...
    KILLER_WEAPON_ID: [KILLER_WEAPON_WIDTH * KILLER_WEAPON_SCALE, KILLER_WEAPON_HEIGHT * KILLER_WEAPON_SCALE],
...
FIRST_ENEMY_SPEED = 15
SECOND_ENEMY_SPEED = 15
THIRD_ENEMY_SPEED = 15

FIRST_PROJECTILE_SPEED = 10
SECOND_PROJECTILE_SPEED = 10
THIRD_PROJECTILE_SPEED = 10
...
CHARACTER_BUTTON_WIDTH = 100
CHARACTER_BUTTON_HEIGHT = 400

EXIT_BUTTON_WIDTH = MENU_BUTTON_WIDTH
EXIT_BUTTON_HEIGHT = MENU_BUTTON_HEIGHT
START_BUTTON_WIDTH = MENU_BUTTON_WIDTH
START_BUTTON_HEIGHT = MENU_BUTTON_HEIGHT
KNIGHT_BUTTON_WIDTH = CHARACTER_BUTTON_WIDTH
KNIGHT_BUTTON_HEIGHT = CHARACTER_BUTTON_HEIGHT
BOXER_BUTTON_WIDTH = CHARACTER_BUTTON_WIDTH
BOXER_BUTTON_HEIGHT = CHARACTER_BUTTON_HEIGHT
WIZARD_BUTTON_WIDTH = CHARACTER_BUTTON_WIDTH
WIZARD_BUTTON_HEIGHT = CHARACTER_BUTTON_HEIGHT
MONK_BUTTON_WIDTH = CHARACTER_BUTTON_WIDTH
MONK_BUTTON_HEIGHT = CHARACTER_BUTTON_HEIGHT
KILLER_BUTTON_WIDTH = CHARACTER_BUTTON_WIDTH
KILLER_BUTTON_HEIGHT = CHARACTER_BUTTON_HEIGHT
CAVEMAN_BUTTON_WIDTH = CHARACTER_BUTTON_WIDTH
CAVEMAN_BUTTON_HEIGHT = CHARACTER_BUTTON_HEIGHT

EXIT_BUTTON_POSITION = (150, 350)
START_BUTTON_POSITION = (150, 50)
KNIGHT_BUTTON_POSITION = (125, 100)
BOXER_BUTTON_POSITION = (140, 100)
WIZARD_BUTTON_POSITION = (350, 100)
MONK_BUTTON_POSITION = (440, 100)
KILLER_BUTTON_POSITION = (575, 100)
...
GAME_FONT_SIZE = 64
PAUSE_TEXT_COLOR = (0, 255, 0)
GAME_OVER_TEXT = "GAME OVER"
GAME_OVER_TEXT_COLOR = (220, 0, 0)
...
STATS_UI_PADDING = 8
STATS_UI_LINE_SPACING = 4
STATS_UI_MARGIN = 6
STATS_UI_BG_COLOR = (20, 20, 50)
STATS_UI_TEXT_COLOR = (255, 215, 0)
STATS_UI_FONT_SIZE = 14

PLAYER_FIRE_DELAY = 20

RANGED_PLAYER_IDS = [WIZARD_ID]

PLAYER_PROJECTILE_MAP = {
    WIZARD_ID: FIRST_PROJECTILE_ID,
}
...
SOUNDS = {KNIGHT_WEAPON_ID : SWORD_ATTACK_PATH,
          KILLER_WEAPON_ID : SWORD_ATTACK_PATH,
